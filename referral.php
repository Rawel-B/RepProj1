            ...
            <div class="row justify-content-center">
                    ...
                    <div class="dashboard-widget mb-30 mb-lg-0 sticky-menu">
                        <div class="user">
                            ...
                            <div class="content">
                                ...
                                <span class="username"><a href="https://pixner.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0d676265634d6a606c6461236e6260">[email&#160;protected]</a></span>
                            </div>
                        </div>
                ...
                <div class="col-lg-8">
                    <div class="dashboard-widget mb-30">
                        <h4 class="title mt-0 mb-20">Welcome to the SmartAuc Referral program.</h4>
                    ...
                    <div class="dashboard-widget mb-30">
                        ...
                        <form action="#0" class="referral-form mb-30">
                            <input type="text" value="https://SmartAuc.com?grsf=y4wyd8" readonly>
                        ...
                        <table class="referral-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td data-label="SmartAuc bidder">jo*@m**********</td>
                                    <td data-label="referrals">01</td>
                                </tr>
                                <tr>
                                    <td data-label="rank">#02</td>
                                    <td data-label="SmartAuc bidder">ma****************@y********</td>
                                    <td data-label="referrals">01</td>
                                </tr>
                                <tr>
                                    <td data-label="rank">#03</td>
                                    <td data-label="SmartAuc bidder">ho********@y********</td>
                                ...
                                <tr>
                                    ...
                                    <td data-label="SmartAuc bidder">ru*@f**********</td>
                                    <td data-label="referrals">00</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="3159545d4171545f565e4559545c541f525e5c">[email&#160;protected]</span></a>
                                </li>
                                <li>
...
<!-- Mirrored from pixner.net/SmartAuc/main/referral.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2023 04:41:51 GMT -->
</html>