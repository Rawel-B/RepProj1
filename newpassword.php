<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST"){
        ...
        $stmt = $mysqli->prepare("SELECT email FROM passwordreset WHERE token=?");
        ...
        if ($invalid_psw || $invalid_pswconf || $not_exist)
        {
            $is_invalid=true;
        }
    }
                ...
                <div class="left-side">
                    ...
                    <form class="login-form" method="post" enctype="multipart/form-data" novalidate>
                        <div class="form-group mb-30">
                            <?php if ($is_invalid): ?>
                                <em style="color: red;font-size: 14px;font-weight: bold">Your Reset Form Contains Mistakes .</em>
                            <?php endif; ?>
                        </div>
                        <div class="form-group mb-30">
                            <?php if ($not_exist): ?>
                                <em style="color: red;font-size: 14px;font-weight: bold">The Email Associated With The Link Does Not Exist .</em>
                            <?php endif; ?>
                        </div>
                        <div class="form-group mb-30">
