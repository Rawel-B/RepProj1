            ...
            <div class="account-wrapper mt--100 mt-lg--440">
                <div class="left-side">
                    <div class="section-header">
                        ...
                        <p>You can log in to your SmartAuc account here.</p>
                    </div>
                    <ul class="login-with">
                        <li>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="137b767f6353767d747c677b767e763d707c7e">[email&#160;protected]</span></a>
                                </li>
                                <li>
