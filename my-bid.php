...
<?php
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if ($result->num_rows > 0)
        {
            ...
            $userDataJSON = json_encode($user_data);
                ...
                <div class="col-lg-8">
                    <div class="dash-bid-item dashboard-widget mb-40-60">
                        ...
                        <ul class="button-area nav nav-tabs">
                            <li>
                                <a href="#auction" data-toggle="tab" class="custom-button active" name="auctionbtn" id="auctionbtn">Auction An Item</a>
                            </li>
                            <script>
                                document.getElementById("auctionbtn").addEventListener("click", function()
                                {
                                    <?php if ($user_data["status"] !== "creator") { ?>
                            ...
                            <li>
                                <a href="#past" data-toggle="tab" class="custom-button">History</a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="row mb-30-none justify-content-center">
                                <?php
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)){
                                        ...
                                        echo '<a href="product-details.php"><img src="upload/' . $row['preview'] . '" alt="' . $row['name'] . '"></a>';
                                        echo '<a href="#0" class="bid"><i class="flaticon-auction"></i></a>';
                                        echo '</div>';
                                        echo '<div class="auction-content">';
                                        echo '<h6 class="title"><a href="#0">' . $row['name'] . '</a></h6>';
                                        echo '</div>';
                                        echo '</div>';
                                        echo '</div>';
                                    }
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="c9a1aca5b989aca7aea6bda1aca4ace7aaa6a4">[email&#160;protected]</span></a>
                                </li>
                                <li>
...
<!-- Mirrored from pixner.net/SmartAuc/main/my-bid.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2023 04:41:51 GMT -->
</html>